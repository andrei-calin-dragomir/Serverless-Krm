...
func main() {
	...
	nodeScoreService := service.NewNodeScoreService(etcdClient)
	nodeScoreHandler := inbound.NewNodeScoreHandler(nodeScoreService)

	mux := http.NewServeMux()
	mux.HandleFunc("POST /scheduler/nodeScore", nodeScoreHandler.HandleNodeScore)
